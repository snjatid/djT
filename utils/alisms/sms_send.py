...
# if __name__ == '__main__':
    ...
    #
    #
    # #print(str(send_sms(__business_id, "13426261244", "北京高立开元数据有限公司", "SMS_147860004", json.dumps({"code": x})), encoding='utf-8'))
    # send_sms(__business_id, "13426261244", "北京高立开元数据有限公司", "SMS_147860004", json.dumps({"code": x}))
